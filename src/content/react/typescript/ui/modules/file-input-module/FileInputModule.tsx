...
import { FileInputModulePropsType } from './file-input-module.type';
import { cn } from '../../utils/styles.util';
import { validateFiles } from './file-input-module.helper';
 ...
 * @param {FileInputModulePropsType} props - The properties object.
 * @returns {JSX.Element} The FileInputModule component.
 */
export function FileInputModule({
	accept,
	disabled,
	maxSize,
	minSize,
	...
	inputProps,
	...props
}: FileInputModulePropsType): JSX.Element {
	...
	return (
		<Container
			as="div"
			className={cn(isDragOver && 'animate-pulse rounded-xl bg-muted-light', className)}
