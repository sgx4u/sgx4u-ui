...
import { ContainerPropsType } from '../../elements/container';
...
/** FileInputModule props type. */
export type FileInputModulePropsType = Omit<ContainerPropsType, ContainerOmittedProps> & {
