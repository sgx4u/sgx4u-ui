...
export const { variants: inputVariants, types: InputVariantTypes } = makeVariants({
	base: 'w-full min-w-20 rounded-md border-2 outline-2 outline-offset-2 outline-transparent transition-colors file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-input-placeholder focus-visible:outline-primary disabled:pointer-events-none disabled:opacity-50',
	variants: {
		variant: {
